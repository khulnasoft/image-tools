module github.com/khulnasoft/image-tools/images/tester/cst
...
require (
	...
	github.com/GoogleContainerTools/container-diff v0.14.1-0.20190219205308-3f6b025c016c // indirect
